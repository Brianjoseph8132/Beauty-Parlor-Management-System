...
const Profile = () => {
  ...
  const handleSaveProfile = async () => {
    ...
    setEditFormData(prev => ({ ...prev, password: "" })); // Clear password after save
  };
              ...
              <form className="space-y-6" onSubmit={(e) => { e.preventDefault(); handleSaveProfile(); }}>
                ...
                <div className="flex flex-col items-center">
                  <div className="relative w-32 h-32 mb-4">
                    <img
                      src={profilePicturePreview || editFormData.profilePicture || "https://media.istockphoto.com/id/1337144146/vector/default-avatar-profile-icon-vector.jpg?s=612x612&w=0&k=20&c=BIbFwuv7FxTWvh5S3vB6bkT0Qv8Vn8N5Ffseq84ClGI="}
                      alt="Profile Preview"
